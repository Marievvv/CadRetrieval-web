...
def write_log(dir, file, e):
    with open(f"{dir}/error_bins.txt", "a") as f:
        f.write("{} {}\n".format(file, e))
...
def process_one_file(arguments):
    ...
    try:
        ...
        write_log(args.log_error, fn_stem + ".bin", "No solids in part")
    except AssertionError as e:
        write_log(args.log_error, fn_stem + ".bin", e)
...
def main():
    ...
    parser.add_argument("log_error", type=str, help="Log of errors in step files")
    parser.add_argument(
